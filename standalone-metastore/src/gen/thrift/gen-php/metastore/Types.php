      ...
      switch ($fid)
      {
        ...
        case 4:
          if ($ftype == TType::LST) {
            ...
            {
              $elem699 = null;
              $elem699 = new \metastore\FieldSchema();
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::LST) {
            ...
            {
              $elem706 = null;
              $elem706 = new \metastore\FindSchemasByColsRespEntry();
              $xfer += $elem706->read($input);
              $this->schemaVersions []= $elem706;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->schemaVersions !== null) {
      ...
      $xfer += $output->writeFieldBegin('schemaVersions', TType::LST, 1);
      {
        ...
        {
          foreach ($this->schemaVersions as $iter707)
          {
