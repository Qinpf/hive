            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.schemaVersions = new ArrayList<FindSchemasByColsRespEntry>(_list794.size);
                FindSchemasByColsRespEntry _elem795;
                for (int _i796 = 0; _i796 < _list794.size; ++_i796)
                {
                  _elem795 = new FindSchemasByColsRespEntry();
                  _elem795.read(iprot);
                  struct.schemaVersions.add(_elem795);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FindSchemasByColsResp struct) throws org.apache.thrift.TException {
      ...
      if (struct.schemaVersions != null) {
        oprot.writeFieldBegin(SCHEMA_VERSIONS_FIELD_DESC);
        {
          ...
          for (FindSchemasByColsRespEntry _iter797 : struct.schemaVersions)
          {
      ...
      if (struct.isSetSchemaVersions()) {
        {
          ...
          for (FindSchemasByColsRespEntry _iter798 : struct.schemaVersions)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.schemaVersions = new ArrayList<FindSchemasByColsRespEntry>(_list799.size);
          FindSchemasByColsRespEntry _elem800;
          for (int _i801 = 0; _i801 < _list799.size; ++_i801)
          {
            _elem800 = new FindSchemasByColsRespEntry();
            _elem800.read(iprot);
            struct.schemaVersions.add(_elem800);
          }
        }
        struct.setSchemaVersionsIsSet(true);
      }
