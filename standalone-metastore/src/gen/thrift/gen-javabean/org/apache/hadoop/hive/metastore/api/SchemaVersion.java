            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.cols = new ArrayList<FieldSchema>(_list786.size);
                FieldSchema _elem787;
                for (int _i788 = 0; _i788 < _list786.size; ++_i788)
                {
                  _elem787 = new FieldSchema();
                  _elem787.read(iprot);
                  struct.cols.add(_elem787);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SchemaVersion struct) throws org.apache.thrift.TException {
      ...
      if (struct.cols != null) {
        oprot.writeFieldBegin(COLS_FIELD_DESC);
        {
          ...
          for (FieldSchema _iter789 : struct.cols)
          {
      ...
      if (struct.isSetCols()) {
        {
          ...
          for (FieldSchema _iter790 : struct.cols)
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.cols = new ArrayList<FieldSchema>(_list791.size);
          FieldSchema _elem792;
          for (int _i793 = 0; _i793 < _list791.size; ++_i793)
          {
            _elem792 = new FieldSchema();
            _elem792.read(iprot);
            struct.cols.add(_elem792);
          }
        }
        struct.setColsIsSet(true);
      }
