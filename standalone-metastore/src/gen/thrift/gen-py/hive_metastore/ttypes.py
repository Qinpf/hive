      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i696 in xrange(_size692):
            _elem697 = FieldSchema()
            _elem697.read(iprot)
            self.cols.append(_elem697)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 5:
...
class FindSchemasByColsResp:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i703 in xrange(_size699):
            _elem704 = FindSchemasByColsRespEntry()
            _elem704.read(iprot)
            self.schemaVersions.append(_elem704)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.schemaVersions is not None:
      ...
      for iter705 in self.schemaVersions:
        iter705.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
